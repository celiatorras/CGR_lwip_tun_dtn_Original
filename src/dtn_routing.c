// dtn_routing.c: Implementation of Contact Graph Routing with time-variant contact management for DTN networks
// Copyright (C) 2025 Michael Karpov & 2026 Cèlia Torras
//
